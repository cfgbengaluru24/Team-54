...
const SendEmailButton = () => {
    ...
    const handleSendEmail = () => {
        ...
        emailjs.send('service_mwmmlqq', 'template_omkssyl', templateParams, 'vHng79LMvBFoDfNIx')
            .then(response => {
            ...
            .catch(error => {
                ...
                setError('Failed to send email. Please check your configuration and try again.');
            })
            .finally(() => {
                setIsSending(false);
            });
